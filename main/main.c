...
static void boot_button_task(void* arg)
{
  ...
  while (1)
  {
    ...
    if (last_level != BOOT_BUTTON_ACTIVE_LEVEL && level == BOOT_BUTTON_ACTIVE_LEVEL &&
...
void app_main(void)
{
  ...
  xTaskCreatePinnedToCore(usb_device_task, "usb_dev", 4096, NULL, 6, NULL, APP_CORE_USB);
  xTaskCreatePinnedToCore(event_router_task, "event_router", 4096, NULL, 5, NULL, APP_CORE_USB);
  xTaskCreatePinnedToCore(boot_button_task, "boot_button", 2048, NULL, 4, NULL, APP_CORE_USB);
